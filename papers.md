# The list of paper ideas

## Project 1. Growth curve modeling with non-normal data through the generalized hyperbolic skew Student’s t distribution.

Growth curve modeling is essential in various fields such as psychology, economics, and social sciences, where understanding the progression of a variable over time is crucial. Real data in these fields often exhibit non-normal characteristics, such as skewness and heavy tails, which can violate the assumptions of traditional growth curve models. The generalized hyperbolic skew Student’s t distribution is a flexible statistical distribution that can capture skewness and heavy tails in data, making it suitable for modeling non-normal growth curves. To estimate the new model, Bayesian methods can be employed. 

## Project 2. Longitudinal data analysis of social network data.
